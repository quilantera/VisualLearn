...
export function LessonListHeader({ firstName,lessonNames }: LessonListHeaderProps) {
    return (
        <ul className=" sm:hidden bg-violet-950 dark:bg-gray-900 dark:border dark:border-slate-50 pr-10 pl-4 ml-2 flex items-center rounded text-white h-14 text-lg sm:text-base sm:text-center sm:tracking-normal tracking-wider  font-normal">
