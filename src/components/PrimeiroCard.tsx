...
export function PrimeiroCard(){
    return (
        <div className="flex w-full h-[12rem] min-w[400px] items-center rounded-xl shadow-sm   bg-indigo-100 p-10 mt-7 relative  dark:bg-zinc-800 ">
            <Image src={initialImage} alt={"imagem boas vindas"} 
            width={300} height={300} 
        
            className="w-[14rem] h-[14rem] opacity-90 absolute bottom-2 left-0"/>
