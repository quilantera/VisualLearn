    ...
    return (
        <div className="" tabIndex={0} >
            ...
            <Select.Root onValueChange={handleSelectChange} >
                ...
                className={`flex border-2 bg-violet-950 dark:bg-gray-900  font-medium text-slate-50
                         border-slate-700 dark:border-slate-50 justify-between items-center w-full gap-4
                          py-2 pl-3 sm:py-1 rounded-md shadow-md cursor-pointer hover:bg-violet-950 hover:text-white duration-300 `}
                         >
                        ...
                        <Select.Viewport className='px-2 py-3 min-w-[240px]'>
                            {options.map((option, index) => (
                                <Select.Item key={index} 
                                    value={option.value} 
                                    className='pl-4 relative flex item-center font-medium  text-lg dark:text-slate-50 hover:bg-violet-950 dark:hover:bg-white dark:hover:text-black hover:text-white'>
